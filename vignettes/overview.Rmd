...
## Summary
  ...
  The data provided in `wnvstormdata` integrates weekly data on tropical cyclone exposure and West Nile Virus confirmed cases for parishes in Louisiana from 2002--2021 to determine if a storm occurred in each parish for the observed week. This data set provides researchers interested in the association between vector-borne disease prevalence and hurricanes with data on cases numbers and when hurricane exposure took place paired by location and time interval.
...
#Plot
ggplot()+
          geom_sf(data = louisiana, aes(fill = factor(round(incidence)), color = exposure))+
          ...
          facet_wrap(~interval)+
          guides(color = FALSE)+
          labs(fill = "WNV Cases per 100,000 People")
